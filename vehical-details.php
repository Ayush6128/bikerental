    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>NRS <?php echo htmlentities($result->PricePerDay);?> </p>Per Day
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget" style="margin-top:75px;">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Book Now</h5>
          </div>
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" id="checkin" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="To Date(dd/mm/yyyy)" id="checkout" required>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">NRS <?php echo htmlentities($result->PricePerDay);?></p>
    ...
    $(function () {
        ...
        $("#checkin").datepicker({
            ...
            onSelect: function (dateText) {
                ...
                $("#checkout").datepicker().datepicker("setDate", nextDay);
                $("#checkout").datepicker().datepicker('option', 'minDate', nextDay);
            }
